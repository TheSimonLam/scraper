...
// public List<Listing> scrapeEbay(String postcode, Integer maxDistance, String
// make, String model, Integer minPrice,
// Integer maxPrice, String minYear, String maxYear, Integer maxMileage, String
// transmission,
// String fuelType) {

// String toStrMaxDistance = filterToUrl(String.valueOf(maxDistance),
// "maxDistance");
...
// String toStrMaxMileage = filterToUrl(String.valueOf(maxMileage),
// "maxMileage");
...
// String html =
// "https://www.autotrader.co.uk/car-search?advertClassification=standard&make="
// + formattedMake
// + "&model=" + formattedModel + toStrMaxDistance + "&postcode=" + postcode +
// toStrMinPrice
// + toStrMaxPrice + minYear + maxYear + toStrMaxMileage + transmission +
// fuelType
// +
...
// Elements scrapedTitles = doc.getElementsByClass("listing-title
// title-wrap").select("*");
